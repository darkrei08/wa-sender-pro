...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, customRef, onScopeDispose, createVNode, Text, Fragment, defineAsyncComponent, Suspense, mergeProps, useSSRContext, withCtx, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu, createDefu } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parsePath, parseQuery, withoutTrailingSlash, isEqual as isEqual$1 } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/ufo/dist/index.mjs";
import { debounce } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/perfect-debounce/dist/index.mjs";
import { hash, isEqual } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import { klona } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/@unhead/vue/dist/index.mjs";
import { parse as parse$1 } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/cookie-es/dist/index.mjs";
import { getRequestURL as getRequestURL$1, getRequestHeader as getRequestHeader$1, getCookie as getCookie$1 } from "/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/h3/dist/index.mjs";
import { setupDevtoolsPlugin } from "@vue/devtools-api";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  {
    name: "api-status___it",
    path: "/api-status",
    component: () => import("./_nuxt/api-status-DkA8qqQR.js")
  },
  {
    name: "api-status___en",
    path: "/en/api-status",
    component: () => import("./_nuxt/api-status-DkA8qqQR.js")
  },
  {
    name: "campaigns___it",
    path: "/campaigns",
    component: () => import("./_nuxt/campaigns-CV8JQ7XZ.js")
  },
  {
    name: "campaigns___en",
    path: "/en/campaigns",
  ...
  },
  {
    name: "connect___it",
    path: "/connect",
    component: () => import("./_nuxt/connect-WTwRIzcH.js")
  },
  {
    name: "connect___en",
    path: "/en/connect",
  ...
  },
  {
    name: "contacts___it",
    path: "/contacts",
    component: () => import("./_nuxt/contacts-Dg-FUjZ4.js")
  },
  {
    name: "contacts___en",
    path: "/en/contacts",
  ...
  },
  {
    name: "settings___it",
    path: "/settings",
    component: () => import("./_nuxt/settings-Dzh8TjSC.js")
  },
  {
    name: "settings___en",
    path: "/en/settings",
  ...
  },
  {
    name: "index___it",
    path: "/",
    component: () => import("./_nuxt/index-D9-CXRS_.js")
  },
  {
    name: "index___en",
    path: "/en",
  ...
  it: [
    {
      ...
      load: () => import(
        "./_nuxt/it-KMKoHkbM.js"
        /* webpackChunkName: "locale_it_46json_af3e3a62" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        "./_nuxt/en-OJuYhd1p.js"
        /* webpackChunkName: "locale_en_46json_3143ff84" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { it: "9e14060a", en: "9e14060a" };
...
var define_I18N_LOCALE_HASHES_default = { it: "9e14060a", en: "9e14060a" };
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BRAJ10Kz.js").then((m) => m.default || m))
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const logs = ref([
      { time: (/* @__PURE__ */ new Date()).toLocaleTimeString(), msg: "Nuxt Nitro Server Started" },
      { time: (/* @__PURE__ */ new Date()).toLocaleTimeString(), msg: "WuzAPI Engine initialized" },
      { time: (/* @__PURE__ */ new Date()).toLocaleTimeString(), msg: "Waiting for socket connection..." }
    ]);
    return (_ctx, _push, _parent, _attrs) => {
      if (isOpen.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed bottom-6 right-6 z-50 w-96 bg-surface-container-high/90 backdrop-blur-xl border border-error/20 rounded-xl shadow-2xl overflow-hidden flex flex-col" }, _attrs))}><div class="px-4 py-3 bg-error/10 border-b border-error/20 flex justify-between items-center cursor-pointer"><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(unref(Bug), { class: "w-4 h-4 text-error" }, null, _parent));
        _push(`<span class="font-bold text-sm text-error">${ssrInterpolate(unref(t)("debug.title"))}</span></div><div class="flex gap-2"><span class="w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.8)]"></span></div></div><div class="p-4 flex flex-col gap-4 max-h-96" style="${ssrRenderStyle(!isCollapsed.value ? null : { display: "none" })}"><div class="flex gap-2"><button class="flex-1 px-3 py-2 bg-white/5 hover:bg-white/10 text-xs font-medium rounded border border-white/10 transition-colors">${ssrInterpolate(unref(t)("debug.mock_connect"))}</button><button class="flex-1 px-3 py-2 bg-error/20 hover:bg-error/30 text-error text-xs font-medium rounded border border-error/30 transition-colors">${ssrInterpolate(unref(t)("debug.disconnect"))}</button></div><div class="flex-1 bg-black/50 rounded p-3 overflow-y-auto font-mono text-[10px] text-green-400 space-y-1"><!--[-->`);
        ssrRenderList(logs.value, (log, i) => {
          _push(`<div class="opacity-80 hover:opacity-100"><span class="text-gray-500">[${ssrInterpolate(log.time)}]</span> ${ssrInterpolate(log.msg)}</div>`);
        });
        _push(`<!--]--></div><button class="w-full py-1.5 text-xs text-gray-400 hover:text-white transition-colors">${ssrInterpolate(unref(t)("debug.clear_logs"))}</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/DebugWidget.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main$3, { __name: "DebugWidget" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const enableDebugWidget = computed(() => {
      return config.public.enableDebugWidget === "true";
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLayout = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_1;
      const _component_DebugWidget = __nuxt_component_2;
      ...
      if (enableDebugWidget.value) {
        _push(ssrRenderComponent(_component_DebugWidget, null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-y69TDO1G.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-D54uRTmA.js"));

declare global {
  ...
  const getCampaignProgress: typeof import('../../server/utils/job-queue').getCampaignProgress
  ...
  const pauseCampaign: typeof import('../../server/utils/job-queue').pauseCampaign
  ...
  const readValidatedBody: typeof import('../../server/utils/validation').readValidatedBody
  const readValidatedQuery: typeof import('../../server/utils/validation').readValidatedQuery
  ...
  const startCampaign: typeof import('../../server/utils/job-queue').startCampaign
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { defineI18nLocale, defineI18nConfig } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/@nuxtjs/i18n/dist/runtime/composables/shared';
export { defineI18nLocaleDetector } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/node_modules/@nuxtjs/i18n/dist/runtime/composables/server';
...
export { startCampaign, pauseCampaign, getCampaignProgress } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/server/utils/job-queue';
export { prisma } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/server/utils/prisma';
export { readValidatedBody, readValidatedQuery } from '/home/ema/Scrivania/altri repooo/wa-sender-pro/server/utils/validation';
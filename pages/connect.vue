    ...
    <div class="max-w-4xl w-full bg-surface-container-low/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
      ...
      <div class="flex flex-col md:flex-row gap-12 items-center">
        ...
        <div class="flex-1 flex flex-col items-center justify-center">
          ...
          <button @click="reloadQr" class="px-6 py-3 bg-primary hover:bg-primary-fixed-dim text-surface font-semibold rounded-lg shadow-[0_0_15px_rgba(37,211,102,0.3)] transition-all flex items-center gap-2">

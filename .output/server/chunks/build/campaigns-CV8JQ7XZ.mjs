    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).loading) {
        ...
        ssrRenderList(unref(store).campaigns, (campaign) => {
          ...
          _push(`</div></div><div class="flex gap-6 mt-4 text-sm text-on-surface-variant"><span>\u{1F4E4} ${ssrInterpolate(campaign.sentCount)} inviati</span><span>\u274C ${ssrInterpolate(campaign.failedCount)} falliti</span><span>\u23F1\uFE0F ${ssrInterpolate(campaign.delayMin)}\u2013${ssrInterpolate(campaign.delayMax)}s delay</span></div></div>`);
        });
        _push(`<!--]-->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=campaigns-CV8JQ7XZ.mjs.map

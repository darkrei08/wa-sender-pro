...
import { getCurrentScope, onScopeDispose, toRef, isRef, inject, computed, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, mergeProps, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, isReadonly, toValue, toRaw, isShallow, isReactive, customRef } from 'vue';
import { H as parseURL, v as encodePath, I as decodePath, J as hasProtocol, K as isScriptProtocol, L as joinURL, M as withQuery, N as sanitizeStatusCode, O as getContext, P as parsePath, Q as parseQuery, $ as $fetch$1, R as baseURL, S as defu, c as createError$1, T as executeAsync, U as hash, V as getRequestURL, W as getRequestHeader, X as getCookie, Y as klona, Z as isEqual, _ as createDefu, a0 as setCookie, a1 as deleteCookie, a2 as withoutTrailingSlash, a3 as isEqual$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    path: "/api-status",
    component: () => import('./api-status-DkA8qqQR.mjs')
  },
  {
  ...
  },
  {
    name: "campaigns___it",
    path: "/campaigns",
    component: () => import('./campaigns-CV8JQ7XZ.mjs')
  },
  {
    name: "campaigns___en",
    path: "/en/campaigns",
  ...
  },
  {
    name: "connect___it",
    path: "/connect",
    component: () => import('./connect-WTwRIzcH.mjs')
  },
  {
    name: "connect___en",
    path: "/en/connect",
  ...
  },
  {
    name: "contacts___it",
    path: "/contacts",
    component: () => import('./contacts-Dg-FUjZ4.mjs')
  },
  {
    name: "contacts___en",
    path: "/en/contacts",
  ...
  },
  {
    name: "settings___it",
    path: "/settings",
    component: () => import('./settings-Dzh8TjSC.mjs')
  },
  {
    name: "settings___en",
    path: "/en/settings",
  ...
  },
  {
    name: "index___it",
    path: "/",
    component: () => import('./index-D9-CXRS_.mjs')
  },
  {
    name: "index___en",
    path: "/en",
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BRAJ10Kz.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-y69TDO1G.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D54uRTmA.mjs'));
...
export { useI18n as a, useState as b, useLocalePath as c, useSwitchLocalePath as d, entry_default as default, useRouter as e, encodeRoutePath as f, useNuxtApp as g, useRuntimeConfig as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, useHead as u };

...
│   ├── connect.vue      # QR Code WhatsApp
│   ├── contacts.vue     # Gestione Contatti
│   ├── campaigns.vue    # Campagne Invio
│   ├── settings.vue     # Impostazioni
│   └── api-status.vue   # Monitor API
...
- **Google Stitch** — Design system e mockup UI
- **Graphify** — Grafo di conoscenza semantica del codebase
- **wiki-brain** — Memoria persistente cross-sessione
- **auto-workflow** — Workflow di sviluppo strutturato
- **spec-kit** — Specifiche e qualità del codice
